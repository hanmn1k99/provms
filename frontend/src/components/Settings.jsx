  ...
  return (
    <div style={{ display: 'flex', height: '100%', background: 'var(--bg)', color: 'var(--text)' }}>
      ...
      <div style={{ flex: 1, overflow: 'auto', padding: '20px' }}>
        {activeTab === 'cameras' ? <CameraManagement cameras={cameras} onCamerasUpdated={onCamerasUpdated} showToast={showToast} /> : <UserManagement cameras={cameras} showToast={showToast} />}
      </div>
    </div>
  );
};
